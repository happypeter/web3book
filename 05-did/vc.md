可验证证书（ Verifiable Credential ，后面简称 VC ），是 W3C 的一个技术规范，是以 DID 作为基础形成的第二层技术基础设施，是 DID 的功能的扩展，可以理解成基于 DID 的智能合约，当然跟当下流行的智能合约还是有很大差异的。W3C 还专门有一个名为可验证声明工作组的组织来从事这方面的工作的推动。
