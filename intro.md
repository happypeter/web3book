...
- wiki: 开篇第一文，应该叫做《什么是 Web3.0 ？》
  - 先来 Web3.0 的技术架构
    - 有人说 Web3.0 是去中心化的互联网，有人说 Web3.0 是可信互联网，其实这二者是一体，中心化的架构，中心节点作为强势的第三方或者中介，可以提供信任，所以不用 Web 本身不必可信。而去中心之后，中介没有了，所以要求 Web 必须自带信任。而“去中心化”和“可信”都是用户真正持有自己数据的技术支撑。
  - 什么是 Web3.0 的目的？
    - 只有一个：用户拥有自己的数据产权。技术是以人为本的，是要解决人的问题的。
    - 服务于这个目的：Web3.0 要变得去中心化，要实现可信。
      - Web3.0 要承载起一个真实经济体（ Web2.0 已经做到的事情，不能退步）。
      - 所以仅仅是用户保存自己的数据是不够的，而是要保留数据的价值，同时要确认我对数据的权益。这些都离不开可信。
  - 再聊要解决什么问题？
    - 让 Web 再次变得开放
      - 巨头对数据的割裂和垄断

- 什么是 Web ？
  - Internet 之上，用户 App 之下的一层
  - 硬件之上，App 之下是操作系统，Web 可以说是 Internet 上的操作系统
  - Web 是一个平台，决定了 App 的运行方式，提供基础设施，但是并不是具体的 App 
  - 所以就可以理解，即使区块链这样的并不属于传统跟浏览器相关的 Web 技术栈的内容，也属于 Web3.0 的范畴
...
- 本书要回答的问题
  ...
  - 本书的角度
    ...
    - 有朋友问我书中会不会涉及到一些各国最新的政策和企业动向，我说不会有的，因为这本书希望让大家从纯技术的角度看出区块链存在的意义。其他书会有这些内容，因为他们的论述角度是有一定的政治经济特点的，很多支持比特币的人是集成了密码朋克的自由主义思想的，尽管这也是理解区块链这波热潮的一个重要的角度，不过的确不是本书要侧重的。
...
- https://www.youtube.com/watch?v=qtOIh93Hvuw
  - 根据 Mneeb Ali 的演讲，互联网有两大问题
    - 一个是基于信任：CA/DNS
      - 解决方案：No middleman
    - 另一个是你不拥有自己的数据
      - 解决方案：Users own their own data
  - 区块链是解决互联网问题的关键：把权力还给个人
